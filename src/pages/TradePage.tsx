...
import { Box, Button, Container, Grid, InputAdornment, MenuItem, Paper, Select, Slider, Stack, TextField, ToggleButton, ToggleButtonGroup, Typography } from "@mui/material";
        ...
        <Grid item xs={12} md={6}>
          <Paper sx={{ height: 300, p: 2, borderRadius: 2 }}>
            <Stack justifyContent="space-between" height="100%">
              <ToggleButtonGroup
                value={tradeType}
                onChange={(event, value: "LONG" | "SHORT" | null) => { if(value !== null) setTradeType(value) }}
                exclusive
                color="primary"
                fullWidth
              >
